...
\begin{figure}
  \centering
  \subcaptionbox{conghuaanalystlr\label{conghuaanalystlr}}
  {\includegraphics[width=0.45\linewidth]{conghuaanalystlr.png}}
  \subcaptionbox{conghuaanalystrbf\label{conghuaanalystrbf}}
  {\includegraphics[width=0.45\linewidth]{conghuaanalystrbf.png}}
  \subcaptionbox{neartestanalystlr\label{neartestanalystlr}}
  {\includegraphics[width=0.45\linewidth]{neartestanalystlr.png}}
  \subcaptionbox{neartestanalystrbf\label{neartestanalystrbf}}
